        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            ...
            <Heading scale="md" color="text">
              {t('Just stake some cryptocurrency to earn SMEx Token.')}
            </Heading>
            <Heading scale="md" color="text">
              {t('High APR, Low Risk.')}
            </Heading>
          ...
          <Heading as="h2" pt={"15px"} lineHeight="1.5 !important">SMEx SWAP's Pools offers you to Stake multiple Cryptocurrency Pools opportunities to you. Double Your Staked amount in rewards by staking your tokens in return for additional SMEx tokens and earning High APR, Low Risk</Heading>
           {/* <HelpButton />
            <BountyCard />*/}
          </Flex>
        </Flex>
